...
<html>
    <head>
        <title>Admin subscriptores</title>
   ...
   <body onload="TiempoActividad()">
        <div class="container">
            ...
            <h3 class="tituloPrincipal text-center phone1" style="font-size:4vw;">Subscriptores</h3>
            <p class="tituloPrincipal text-center phone1 text-success" style="font-size:2vw;"><?php echo $ustedes;  ?></p>
            <h3 class="tituloPrincipal text-center phone" style="font-size:11vw;">Subscriptores</h3>
            ...
            <div class="row">
                ...
                <div class="col d-flex align-items-end mb-3 ml-3">
                    <div class="justify-content-center">
                        <a href="listarsubscribe.php" title="Actualizar"><img src="./img/actualizar.png"></a>
                    </div>
                </div>
            </div>
            <table class="table table-responsive-sm table-striped mt-4">
                ...
                <?php
                    ...
                    $consulta= "SELECT * FROM subscribe order by ID_subscribe DESC";
                ...
                ?><!--aqui esta la ensalada 🥗 apertura de ciclo-->
                    ...
                    <tr scope="row">
                        ...
                        <td><a href="eliminarsubscriptor.php?id=<?php echo $filas['ID_subscribe']; ?>" title="Eliminar"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
